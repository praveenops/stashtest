...
import { Action, ActionReducer, ActionsSubject, ReducerManager, StateObservable } from '@ngrx/store';
import { Provider } from '@angular/core';
import { CustomAction } from './app/_store/custom-action';
...
export declare class Store<T> extends Observable<T> implements Observer<Action> {
  ...
  dispatch<V extends CustomAction = CustomAction>(action: V): void;
